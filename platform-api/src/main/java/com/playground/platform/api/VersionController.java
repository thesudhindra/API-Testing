...
public class VersionController {
    ...
    private static final String FALLBACK_NAME = "platform-api";
    ...
    @Operation(
            ...
            description = "Returns build and application version metadata.",
            extensions = @Extension(name = "x-learning-objective", properties = @ExtensionProperty(name = "id", value = "LO-BOOT-02")))
